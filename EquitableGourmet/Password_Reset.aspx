                ...
                <div class="login-box clearfix animated flipInY">
                    ...
                    <div class="login-form">
                        ...
                        <form runat ="server" method="post">
                            <p>Enter your username below and we'll send you the password reset URL to your inbox.</p>
                            <input runat="server" name="txtUsername" id="txtUsername" type="text" placeholder="username" class="input-field" required />
                            <asp:button id="btnSubmit" class="btn btn-login btn-reset" data-style="expand-left" runat="server" text="SEND password" onclick="btnSubmit_Click" />
