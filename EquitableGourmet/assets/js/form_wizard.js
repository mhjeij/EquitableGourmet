$(function () {
    ...
    $(".form-wizard").steps({
        ...
        onFinished: function (event, currentIndex) {
            ...
            $.ajax({
                type: "GET",
                url: "AccountSubmit.ashx",
                data: {
                    //account fields
                    accountTitleSelect: $("#accountTitleSelect").val(),
                    accountClassSelect: $("#accountClassSelect").val(),
                    accountIndustrySelect: $("#accountIndustrySelect").val(),
                    accountTypeSelect: $("#accountTypeSelect").val(),
                    txtCompanyName: $("#txtCompanyName").val(),
                    txtDisplayName: $("#txtDisplayName").val(),
                    txtEmail: $("#txtEmail").val(),
                    txtMarigoldNumber: $("#txtMarigoldNumber").val(),
                    txtTelephone1: $("#txtTelephone1").val(),
                    txtTelephone1: $("#txtTelephone1").val(),
