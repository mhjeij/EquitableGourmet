...
namespace DL
{
	public abstract class ControlTypeBase
	{
		...
		protected ControlTypeBase(int ControlTypeID) : this()
		{
			_ControlTypeID = ControlTypeID;
		}
	
		protected ControlTypeBase(int ControlTypeID, string Name, bool Del) : this()
		{
			_ControlTypeID = ControlTypeID;
			_Name = Name;
			_Del = Del;
		...
		#region Utilerias
		public static bool Existe(int ControlTypeID)
		{
			Database db = DatabaseFactory.CreateDatabase();
			string sqlCommand = "daab_ExistsControlType";
		...
		public static DataTable GetAllControlType()
		{
			Database db = DatabaseFactory.CreateDatabase();

			string sqlCommand = "daab_GetAllControlType";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);
			DataTable ret = db.ExecuteDataSet(dbCommandWrapper).Tables[0];
			
            ret.PrimaryKey = new DataColumn[] { ret.Columns["ControlTypeID"] };
		...
		public static void SaveAll(DataTable tabla)
		{
			...
			da.SelectCommand = db.GetStoredProcCommand("daab_GetAllControlType");
            da.InsertCommand = db.GetStoredProcCommand("daab_AddControlType");
            da.UpdateCommand = db.GetStoredProcCommand("daab_UpdateControlType");
            da.DeleteCommand = db.GetStoredProcCommand("daab_DeleteControlType");
			
			#region Parametros de InsertCommand
			db.AddOutParameter(da.InsertCommand, "@ControlTypeID", DbType.Int32, 4);
			...
			db.AddInParameter(da.DeleteCommand, "@ControlTypeID", DbType.Int32, "ControlTypeID", DataRowVersion.Default);
		...
		private DataSet LoadByPrimaryKey(int ControlTypeID)
		{
			// Create the Database object, using the default database service. The
			// default database service is determined through configuration.
			Database db = DatabaseFactory.CreateDatabase();

			string sqlCommand = "daab_GetControlType";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);
		...
		/// </summary>
		/// <param name="ControlTypeID"></param>
		public virtual void Load(int ControlTypeID)
		{
			// DataSet that will hold the returned results		
			DataSet ds = this.LoadByPrimaryKey(ControlTypeID);
			
			// Load member variables from datarow
			DataRow row = ds.Tables[0].Rows[0];
			_ControlTypeID = (int)row["ControlTypeID"];
		...
		private bool Insert()
		{
			...
			string sqlCommand = "daab_AddControlType";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);

			// Add parameters
			db.AddOutParameter(dbCommandWrapper, "@ControlTypeID", DbType.Int32, 4);
			...
			object param;
			param = db.GetParameterValue(dbCommandWrapper, "@ControlTypeID");
			if (param == DBNull.Value) return false;
			_ControlTypeID = (int)param;
		...
		public bool Update()
		{
			...
			string sqlCommand = "daab_UpdateControlType";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);

			// Add parameters
			db.AddInParameter(dbCommandWrapper, "@ControlTypeID", DbType.Int32, _ControlTypeID);
			db.AddInParameter(dbCommandWrapper, "@Name", DbType.String, SetNullValue((_Name == string.Empty), _Name));
			db.AddInParameter(dbCommandWrapper, "@Del", DbType.Boolean, SetNullValue((_Del == false), _Del));
		...
		/// </summary>
		/// <param name="ControlTypeID"></param>
		public static void Remove(int ControlTypeID)
		{
			// Create the Database object, using the default database service. The
			// default database service is determined through configuration.
			Database db = DatabaseFactory.CreateDatabase();

			string sqlCommand = "daab_DeleteControlType";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);
		...
		{
			// DataSet that will hold the returned results		
			DataSet ds = this.LoadByPrimaryKey(_ControlTypeID);
