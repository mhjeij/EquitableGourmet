...
namespace EquitableGourmet
{
	public abstract class CountryBase
	{
		...
		protected CountryBase(int CountryID) : this()
		{
			_CountryID = CountryID;
		}
	
		protected CountryBase(int CountryID, string Name, bool Del) : this()
		{
			_CountryID = CountryID;
			_Name = Name;
			_Del = Del;
		...
		#region Utilerias
		public static bool Existe(int CountryID)
		{
			Database db = DatabaseFactory.CreateDatabase();
			string sqlCommand = "daab_ExistsCountry";
		...
		public static DataTable GetAllCountry()
		{
			...
			string sqlCommand = "daab_GetAllCountry";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);
			DataTable ret = db.ExecuteDataSet(dbCommandWrapper).Tables[0];
			
            ret.PrimaryKey = new DataColumn[] { ret.Columns["CountryID"] };
		...
		public static void SaveAll(DataTable tabla)
		{
			...
			da.SelectCommand = db.GetStoredProcCommand("daab_GetAllCountry");
            da.InsertCommand = db.GetStoredProcCommand("daab_AddCountry");
            da.UpdateCommand = db.GetStoredProcCommand("daab_UpdateCountry");
            da.DeleteCommand = db.GetStoredProcCommand("daab_DeleteCountry");
			
			#region Parametros de InsertCommand
			db.AddOutParameter(da.InsertCommand, "@CountryID", DbType.Int32, 4);
			...
			db.AddInParameter(da.DeleteCommand, "@CountryID", DbType.Int32, "CountryID", DataRowVersion.Default);
		...
		private DataSet LoadByPrimaryKey(int CountryID)
		{
			// Create the Database object, using the default database service. The
			// default database service is determined through configuration.
			Database db = DatabaseFactory.CreateDatabase();

			string sqlCommand = "daab_GetCountry";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);
		...
		/// </summary>
		/// <param name="CountryID"></param>
		public virtual void Load(int CountryID)
		{
			// DataSet that will hold the returned results		
			DataSet ds = this.LoadByPrimaryKey(CountryID);
			
			// Load member variables from datarow
			DataRow row = ds.Tables[0].Rows[0];
			_CountryID = (int)row["CountryID"];
		...
		private bool Insert()
		{
			...
			string sqlCommand = "daab_AddCountry";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);

			// Add parameters
			db.AddOutParameter(dbCommandWrapper, "@CountryID", DbType.Int32, 4);
			...
			object param;
			param = db.GetParameterValue(dbCommandWrapper, "@CountryID");
			if (param == DBNull.Value) return false;
			_CountryID = (int)param;
		...
		public bool Update()
		{
			...
			string sqlCommand = "daab_UpdateCountry";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);

			// Add parameters
			db.AddInParameter(dbCommandWrapper, "@CountryID", DbType.Int32, _CountryID);
			db.AddInParameter(dbCommandWrapper, "@Name", DbType.String, SetNullValue((_Name == string.Empty), _Name));
		...
		public static void Remove(int CountryID)
		{
			...
			string sqlCommand = "daab_DeleteCountry";
			DbCommand dbCommandWrapper = db.GetStoredProcCommand(sqlCommand);
		...
		{
			// DataSet that will hold the returned results		
			DataSet ds = this.LoadByPrimaryKey(_CountryID);
